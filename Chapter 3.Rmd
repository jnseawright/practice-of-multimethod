...
```{r, echo=TRUE}
meetpressDTM <- read.csv("https://raw.githubusercontent.com/jnseawright/practice-of-multimethod/refs/heads/main/meet-the-press/meetpressdtm.csv")
```
...
```{r, echo=TRUE}
climategoogletrendsdata <- read.csv("https://raw.githubusercontent.com/jnseawright/practice-of-multimethod/refs/heads/main/meet-the-press/climate.csv")
```
